...
export function withAddToCart<OriginalProps extends AddToCartProps>(ChildrenComponent: React.ComponentType<OriginalProps>)
{
    const AddToCartHOC = (props: Omit<OriginalProps, keyof AddToCartProps>) => {
        ...
        return(
            <ChildrenComponent {...(props as OriginalProps)} addToCart={handleAddToCartClick}/>
        );
    }
    return AddToCartHOC;
}
